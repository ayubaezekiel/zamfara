...
const operatedCases = [
  {
    type: 'Groin Swellings & Lumps/Special - others',
    pc: 'GH, Gusau Main Theatre',
    total: 1215,
  },
  {
    type: 'Groin Swellings & Lumps/Special - others',
  ...
  {
    type: 'Cataract Extraction & others',
    pc: 'Eye Centre',
    total: 1081,
  },
  {
    type: 'Vesico-vaginal/rectal fistula, and prolapse',
    pc: 'Farida VVF',
    total: 118,
  },
  {
    type: 'Undescended testes',
    pc: 'YBSH Theatre',
    total: 26,
  },
  {
    type: 'Seropositive cases',
    pc: 'Various Centres',
    total: 25,
  },
]
...
const columns: ColumnDef<OperatedCase>[] = [
  ...
  {
    accessorKey: 'pc',
    header: 'Performing Centre',
  },
  {
    accessorKey: 'total',
    header: 'Number of Individuals Operated',
  },
]
    ...
    <div className="min-h-screen bg-linear-to-br from-background to-blue-50">
      <div className="py-24 px-4 max-w-7xl mx-auto">
            ...
            <CardContent>
              <CardDescription className="text-muted-foreground space-y-4 leading-relaxed">
                ...
                <p>
                  ...
                  devastated by VVF. This has saved many families' income that
                  would have been used to seek treatment.
                </p>
                <p>
        ...
        <div className="mb-16">
          ...
          <p className="text-red-800 text-2xl mt-6 font-semibold">
            GRAND TOTAL = 3,447
          </p>
          <p className="text-red-800 text-xl mt-4 italic">
            NOTE: More than 3,447 operations were actually performed due to
            bilaterality or multiplicity of sites in some individuals
          </p>
        </div>
